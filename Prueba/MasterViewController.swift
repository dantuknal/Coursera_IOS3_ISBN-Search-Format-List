...
//    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showDetail" {
            if let indexPath = self.tableView.indexPathForSelectedRow {
                //let object = libros[indexPath.row]
                let object = BookStore.sharedInstance.get(indexPath.row)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //cell.textLabel!.text = self.libros[indexPath.row]
        let task = BookStore.sharedInstance.get(indexPath.row)
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == .Delete {
            ...
            BookStore.sharedInstance.removeTaskAtIndex(indexPath.row)
